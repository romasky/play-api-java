 ...
 * The single @Before that sets ScenarioContext.current lives in CommonSteps.
 */
public class BaseSteps {
    ...
    protected void save(String key, Object value) {
        if (key.endsWith("_g")) {
            ...
            String scenarioName = ScenarioContext.current.getName();
    ...
    protected Object get(String key, boolean failIfMissing) {
        ...
        if (isGlobal) {
            ...
            var localMap = ScenarioContext.local.get(ScenarioContext.current.getName());
            if (localMap != null) {
